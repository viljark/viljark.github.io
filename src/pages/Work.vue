  ...
  <article>
    <section>
      ...
      <ul>
        ...
        <li><a href="https://eteenindus.mnt.ee/main.jsf">Estonian Road Administration</a></li>
        <li><a href="https://www.tallink.ee">Tallink</a></li>
        <li><a href="http://www.galacoral.co.uk/">Gala Coral Group</a></li>
        <li><a href="http://www.sudameapteek.ee/">Südameapteek</a></li>
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Movie watchlist application, using <a href="http://ionicframework.com/">Ionic</a></strong>
          </p>
        </li>
      </ul>
    </section>
